...
let ProductController = class ProductController {
    ...
    addProduct(title, desc, price) {
        const id = this.productService.insert(title, desc, price);
        return { id: id };
    }
    infoProduct() {
    ...
    change(id, title, desc, price) {
        this.change(id, title, desc, price);
        return null;
    }
    delete(id) {
        this.delete(id);
...
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ProductController.prototype, "infoProduct", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], ProductController.prototype, "getId", null);
__decorate([
    (0, common_1.Patch)(":id"),
